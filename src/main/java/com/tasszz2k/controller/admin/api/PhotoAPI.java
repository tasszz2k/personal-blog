 ...
 * @author TASS
 */
@WebServlet(name = "PhotoAPI", urlPatterns = {"/api-admin-photo"})
public class PhotoAPI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PhotoAPI</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PhotoAPI at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        photoModel.setUserId(9L);
        photoModel = photoService.save(photoModel);
