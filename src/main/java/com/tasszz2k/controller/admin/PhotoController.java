 ...
 * @author TASS
 */
@WebServlet(name = "PhotoController", urlPatterns = {"/admin-photo"})
public class PhotoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String view = "";
        if (photo.getType().equals(SystemConstant.LIST)) {
            //set list result
            ...
            //set list result
            view = "/view/admin/listPhotos.jsp";
        }else if (photo.getType().equals(SystemConstant.EDIT)) {
            if (photo.getId() != null) {
                photo = photoService.findOne(photo.getId());

            } else {
                //
            }
            view = "/view/admin/editPhoto.jsp";
        }
