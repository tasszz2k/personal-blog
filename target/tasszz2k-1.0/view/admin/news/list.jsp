            ...
            function deleteNews(data) {
                $.ajax({
                    ...
                    success: function (result) {
                        console.log(result);
                        window.location.href = "${NewsURL}?type=list&page=1&maxPageItem=5&sortBy=id&sortType=desc&message=delete_success";
                    },
                    error: function (error) {
                        console.log(error);
                        window.location.href = "${NewsURL}?type=list&page=1&maxPageItem=5&sortBy=id&sortType=desc&message=error_system";
                    }
                });
            }
